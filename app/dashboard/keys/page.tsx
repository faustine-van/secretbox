...
import { Key, Shield, Search, Plus } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
            Securely store and manage your API keys, tokens, and sensitive credentials with enterprise-grade encryption
          </p>
        </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-slate-900 dark:text-slate-100">4</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-slate-900 dark:text-slate-100">2h</p>
                </div>
